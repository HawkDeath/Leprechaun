...
#define LOG(...)                                                               \
  do {                                                                         \
    Leprechaun::Logger::get_logger().print_info(__VA_ARGS__);                         \
  } while (0)
#define WLOG(...)                                                              \
  do {                                                                         \
    Leprechaun::Logger::get_logger().print_warning(__VA_ARGS__);                      \
  } while (0)
#define ELOG(...)                                                              \
  do {                                                                         \
    Leprechaun::Logger::get_logger().print_error(__VA_ARGS__);                        \
  } while (0)
